...
public class MessageDAO implements IMessageDao {
    ...
    public void save(Message message) throws Exception {
        ...
        QueryParameters params = new QueryParameters() {
            ...
            public void setParameters(PreparedStatement pst) throws SQLException {
                ...
                pst.setString(8, String.valueOf(message.getIsEphemeral() ? 1 : 0));
    ...
    public void updateTextContent(String messageId, String textContent) throws Exception {
        try {
            String query = "UPDATE messages SET text_content=? WHERE id=?";
            QueryParameters params = new QueryParameters() {
                @Override
                public void setParameters(PreparedStatement pst) throws SQLException {
                    pst.setString(1, textContent);
                    pst.setString(2, messageId);
                }
            };
            helper.update(query, params);
