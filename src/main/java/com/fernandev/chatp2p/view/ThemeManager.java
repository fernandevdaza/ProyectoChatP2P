...
public class ThemeManager {
    ...
    public void applyTheme(String themeId, Component anchor) {
        ...
        Window window = (anchor instanceof Window)
                ? (Window) anchor
